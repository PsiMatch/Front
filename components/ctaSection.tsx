...
export default function CtaSection() {
  return (
    <section id="cuestionario" className="w-full flex flex-col items-center justify-center gap-6 py-25 px-6 lg:px-0 bg-iris text-white">
      <h2 className="text-center text-4xl font-bold">Tu camino hacia el bienestar comienza aquí.</h2>
